...
import {  proxy, selectedRecordId, getMedicalRecordWithId } from "../../actions/index";
...
useEffect(() => {
  if(seletedRecord.recordData.treatment){
    ...
    if(props.location.state.id){
      ...
      axios.get(`${proxy}/getmedicalrecordbyid/?medicalid=${props.location.state.id}`)
      .then(res => {
...
const onTreatmentUpdate=  (e) => {
  ...
  axios.put(`${proxy}/updatetreatment/?recordId=${recordId}`, data)
  ...
  <Col sm="10">
    <Form.Control type="text" onChange={e => setAnamneses(e.target.value)} placeholder="Anamneses" value={anamneses} />
  </Col>
</Form.Group>
...
<Col sm="10">
<Form.Control type="text" onChange={e => setDiagnoses(e.target.value)} placeholder="Diagnoses" value={diagnoses}/>
</Col>
</Form.Group>
<Form.Group as={Row} controlId="formanamneses">
<Form.Label column sm="2">
...
<Col sm="10">
<Form.Control type="text" onChange={e => setLocationOfTreatment(e.target.value)} placeholder="Location Of Treatment" value={locationOfTreatment} />
</Col>
</Form.Group>
<Form.Group as={Row} controlId="formanamneses">
<Form.Label column sm="2">
...
<Col sm="10">
<Form.Control type="text" onChange={e => setMedicalFindings(e.target.value)} placeholder="Medical Findings" value={medicalFindings}/>
</Col>
</Form.Group>
<Form.Group as={Row} controlId="formanamneses">
<Form.Label column sm="2">
...
<Col sm="10">
<Form.Control type="text" onChange={e => setMedications(e.target.value)} placeholder="Medications" value={medications} />
</Col>
</Form.Group>
<Form.Group as={Row} controlId="formanamneses">
<Form.Label column sm="2">
...
<Col sm="10">
<Form.Control type="text" onChange={e => setMedicalLetter(e.target.value)} placeholder="Medical Letter" value={medicalLetter}/>
</Col>
</Form.Group>
<Form.Group as={Row} controlId="formanamneses">
<Form.Label column sm="2">
...
<Col sm="10">
<Form.Control type="text" onChange={e => setStatus(e.target.value)} placeholder="Status" value={status} />
</Col>
</Form.Group>
<Form.Group as={Row} controlId="formanamneses">
<Form.Label column sm="2">
...
<Col sm="10">
<Form.Control type="date" onChange={e => setTreatmentDate(e.target.value)} placeholder="Treatment Date" value={treatmentDate}/>
</Col>
</Form.Group>
<Button onClick={onTreatmentUpdate} variant="primary" type="submit">
   Update Treatment
</Button>{" "}
</Form>
